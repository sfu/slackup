...
module.exports = function invite({ org, token, email, channel }, fn){
  ...
  .end(function(err, res){
    ...
    if (!ok) {
      if (providedError === 'missing_scope' && needed === 'admin') {
        ...
        fn(new Error(`You are already a member of the SFU ITS Slack. You can reset your password at https://${org}.slack.com/forgot`))
      } else {
